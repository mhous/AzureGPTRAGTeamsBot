...
export async function chatApiGpt(backendEndpoint: string, options: ChatRequestGpt): Promise<AskResponseGpt> {
    const response = await fetch(backendEndpoint + "/chatgpt", {
        method: "POST",
        headers: {
